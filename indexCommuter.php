...
<body>
    ...
    <nav class="navbar navbar-expand-xl navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a href="commuterLoc.php">
              <button type="submit" class="btn btn-success btn-lg navBtn">Commuter Loc</button>
            </a>
          </li>
          <li class="nav-item">
            <a href="aboutusCommuter.php">
  ...
  <div class="facilities-section">
    ...
    <div class="row cards-section">
      <div class="pricing-col col col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <h3>Commuter Location</h3>
          </div>
          <div class="card-body d-grid gap-2">
            <div><i class="fa-solid fa-person fa-6x feature-image"></i></div>
            <p class="card-text">Enter the location of the commuter.</p>
            <a href="">
              <button type="submit" class="btn btn-dark btn-lg">Commuter Location</button>
            </a>
          </div>
        </div>
      </div>
