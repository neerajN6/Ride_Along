...
<table class="table table-dark">
  ...
  <tbody>
    <?php
        ...
        $sql1 = "select * from commuter, owner_loc, commuter_loc where commuter.CommuterID='$commuter_id' and commuter.CommuterID=commuter_loc.CommuterID and commuter_loc.FinalLoc=owner_loc.FinalLoc";
        $sql2 = "";
