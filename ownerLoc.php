<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    if(!empty($final_loc))
    {
      ...
      //save to database
      $query = "insert into owner_loc (OwnerID,FinalLoc) values ('$owner_id','$final_loc')";

      mysqli_query($con, $query);
      header("Location: ownerLoc.php");
...
<body class="text-center">
  ...
  <div class="container-fluid">
    ...
    <div class="box">
        <h2>Owner Destination Location</h2>
      
        <form action="" class="input-box" method="POST" class="transfer-form mt-5">
          <div class="form-group">
            <select name="finalLoc" id="finalLoc" class="inputs form-control form-control-lg rounded-0 rounded-bottom rounded-top">
